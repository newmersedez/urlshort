...
// Dispose provides a mock function for the type MockLogger
func (_mock *MockLogger) Dispose() {
	_mock.Called()
	return
}

// MockLogger_Dispose_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Dispose'
type MockLogger_Dispose_Call struct {
	*mock.Call
}

// Dispose is a helper method to define mock.On call
func (_e *MockLogger_Expecter) Dispose() *MockLogger_Dispose_Call {
	return &MockLogger_Dispose_Call{Call: _e.mock.On("Dispose")}
}

func (_c *MockLogger_Dispose_Call) Run(run func()) *MockLogger_Dispose_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockLogger_Dispose_Call) Return() *MockLogger_Dispose_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockLogger_Dispose_Call) RunAndReturn(run func()) *MockLogger_Dispose_Call {
	_c.Run(run)
	return _c
}
